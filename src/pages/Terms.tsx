      ...
      <div className="container mx-auto px-4 py-20 max-w-4xl">
        ...
        <div className="mb-12">
          ...
          <p className="text-xl text-muted-foreground">
            These terms govern your use of TherapEase and our practice
            management services. Please read them carefully.
          </p>
        </div>
        ...
        <div className="space-y-8">
          <Card className="border-0 shadow-lg">
            ...
            <CardContent className="prose prose-gray max-w-none">
              <p>
                By accessing or using TherapEase services, you agree to be bound
              ...
              <p>
                ...
                therapists, practice administrators, and any authorized users of
                your account.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border-0 shadow-lg">
            ...
            <CardContent className="prose prose-gray max-w-none">
              <p>
                ...
                specifically designed for mental health professionals. Our
                services include:
              </p>
              <ul>
          ...
          <Card className="border-0 shadow-lg">
            ...
            <CardContent className="prose prose-gray max-w-none">
              ...
              <ul>
                <li>
                  Be a licensed mental health professional or authorized staff
                  member
                </li>
          ...
          <Card className="border-0 shadow-lg">
            ...
            <CardContent className="prose prose-gray max-w-none">
              <p>As a healthcare technology platform, you acknowledge that:</p>
              <ul>
                <li>
                ...
                <li>
                  Clinical decisions and treatments remain solely your
                  responsibility
                </li>
                <li>
          ...
          <Card className="border-0 shadow-lg">
            ...
            <CardContent className="prose prose-gray max-w-none">
              <p>
                <strong>Your Data:</strong> You retain ownership of all client
                data and practice information you input into our system. We act
              ...
              <ul>
                ...
                <li>
                  Maintain current contact information for security notices
                </li>
              </ul>
            </CardContent>
          </Card>
          ...
          <Card className="border-0 shadow-lg">
            ...
            <CardContent className="prose prose-gray max-w-none">
              <p>
                <strong>Subscription Fees:</strong> Our services are provided on
                a subscription basis. Fees are billed in advance based on your
                selected plan.
              </p>
              ...
              <p>
                <strong>Free Trials:</strong> Free trial periods are available
                for new accounts. Trials automatically convert to paid
          ...
          <Card className="border-0 shadow-lg">
            ...
            <CardContent className="prose prose-gray max-w-none">
              ...
              <ul>
                ...
                <li>
                  Use our platform for purposes other than practice management
                </li>
                <li>
          ...
          <Card className="border-0 shadow-lg">
            ...
            <CardContent className="prose prose-gray max-w-none">
              <p>
                ...
                cannot guarantee uninterrupted access due to:
              </p>
              <ul>
          ...
          <Card className="border-0 shadow-lg">
            ...
            <CardContent className="prose prose-gray max-w-none">
              <p>
                <strong>Service Limitations:</strong> Our platform is provided
                "as is" without warranties of any kind. We do not guarantee that
                our services will meet all your requirements or be error-free.
              </p>

              <p>
                <strong>Liability Limits:</strong> To the maximum extent
                permitted by law, our total liability for any claims related to
                our services shall not exceed the amount you paid us in the 12
          ...
          <Card className="border-0 shadow-lg">
            ...
            <CardContent className="prose prose-gray max-w-none">
              <p>
                ...
                time through your account settings. Cancellation takes effect at
              ...
              <p>
                <strong>Data Export:</strong> Upon termination, you have 30 days
                to export your data. After this period, your data will be
          ...
          <Card className="border-0 shadow-lg">
            ...
            <CardContent className="prose prose-gray max-w-none">
              ...
              <ul>
                ...
                <li>
                  Mail: TherapEase Legal Department
                  <br />

  ...
  const milestones = [
    {
      ...
      description: "Started with a vision to simplify therapy practice management",
    },
    {
      year: "2021",
      title: "First 1,000 Users",
      description: "Reached our first milestone with therapists across 20 states",
    },
    {
      year: "2022",
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground">
              Key milestones in our mission to transform therapy practice management
            </p>
          </div>
